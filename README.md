...
|REFERENCES| To show related pages, external links, and mentioned media at the end of the post. BODY_LINK_POPUPS - not yet implemented to display a snippet when hovering over a post link in the body.|
